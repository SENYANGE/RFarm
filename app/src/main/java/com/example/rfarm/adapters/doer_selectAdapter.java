...
public class doer_selectAdapter extends RecyclerView.Adapter<doer_selectAdapter.ViewHolder> {
    ...
    public doer_selectAdapter(Context context, List<Rabbit> TempList,OnItemClickListener listener) {
    ...
    @Override
    public doer_selectAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.herd_row, parent, false);

        doer_selectAdapter.ViewHolder viewHolder = new doer_selectAdapter.ViewHolder(view);

        return viewHolder;
    }

    @Override
    public void onBindViewHolder(doer_selectAdapter.ViewHolder holder, int position) {
