...
public class buck_selectAdapter extends RecyclerView.Adapter<buck_selectAdapter.ViewHolder> {
    ...
    public buck_selectAdapter(Context context, List<Rabbit> TempList,OnItemClickListener listener) {
    ...
    @Override
    public buck_selectAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.herd_row, parent, false);

        buck_selectAdapter.ViewHolder viewHolder = new buck_selectAdapter.ViewHolder(view);

        return viewHolder;
    }

    @Override
    public void onBindViewHolder(buck_selectAdapter.ViewHolder holder, int position) {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(Rabbit rabbit, OnItemClickListener listener) {
