...
public class SalesRecords extends AppCompatActivity {
    RecyclerView salesRecycler;
    RecyclerView.Adapter adapter ;
    ProgressDialog progressDialog;
    // Creating List of ImageUploadInfo class.
    List<Rabbit_Products> list = new ArrayList<>();
            ...
            public boolean onNavigationItemSelected(@NonNull @NotNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_message_id:
                        startActivity(new Intent(SalesRecords.this,Doer_buck.class));
                        //closeDrawer();
                        finish();
                        break;
                    case R.id.nav_chat_id:
                        startActivity(new Intent(SalesRecords.this,Bunnies.class));
                        //closeDrawer();
                        finish();
                        break;
                    case R.id.nav_home:
                    ...
                    case R.id.nav_profile_id:
                        startActivity(new Intent(SalesRecords.this,Sales.class));
                        //closeDrawer();
                        finish();
                        break;
                    case R.id.nav_notebooks_id:
                        startActivity(new Intent(SalesRecords.this,Expenses.class));
                        //closeDrawer();
                        finish();
                        break;
                    case R.id.nav_send_id:
                        startActivity(new Intent(SalesRecords.this,Herd.class));
                        //closeDrawer();
                        finish();
                        break;
                    case R.id.nav_share_id:
                        startActivity(new Intent(SalesRecords.this,Expenses_Records.class));
                        //closeDrawer();
                        finish();
                        break;
                    case R.id.nav_photos_id:
                        startActivity(new Intent(SalesRecords.this,BreedingRabbits.class));
                        // closeDrawer();
                        finish();
                        break;
                    case R.id.nav_trash_id:
                        startActivity(new Intent(SalesRecords.this,BreedingHistory.class));
                        // closeDrawer();
                        finish();
                        break;
                    case R.id.nav_settings_id:
                        startActivity(new Intent(SalesRecords.this,SalesRecords.class));
                        //closeDrawer();
                        finish();
                        break;
                    case R.id.nav_signout_id:
                        ...
                        androidx.appcompat.app.AlertDialog alertDialog = new androidx.appcompat.app.AlertDialog.Builder(SalesRecords.this)
//set icon
...
//set positive button
                                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                        ...
                                        startActivity(new Intent(SalesRecords.this,Home.class));
                                        finish();
                                    }
                                })
//set negative button
...
//drawer email and user name
        ...
        salesRecycler=findViewById(R.id.sales_recyclerview);
        progressDialog=new ProgressDialog(this);
        // Setting RecyclerView size true.
        salesRecycler.setHasFixedSize(true);

        // Setting RecyclerView layout as LinearLayout.
        salesRecycler.setLayoutManager(new LinearLayoutManager(SalesRecords.this));

        // Assign activity this to progress dialog.
        progressDialog = new ProgressDialog(SalesRecords.this);
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                for(DataSnapshot postSnapshot:snapshot.getChildren()){
                    Rabbit_Products sales=postSnapshot.getValue(Rabbit_Products.class);
                    list.add(sales);



                }
                adapter=new SalesRecordAdapter(SalesRecords.this, list, new SalesRecordAdapter.OnItemClickListener() {
                    @Override
                    public void onItemClick(Rabbit_Products item) {
                        Toast.makeText(getApplicationContext(),"sold on: "+item.getDate_sold(),Toast.LENGTH_SHORT).show();
                    }
                });
                adapter.notifyDataSetChanged();
                itemDecorator = new DividerItemDecoration(SalesRecords.this, DividerItemDecoration.VERTICAL);
                itemDecorator.setDrawable(ContextCompat.getDrawable(SalesRecords.this, R.drawable.divider));

                salesRecycler.addItemDecoration(itemDecorator);
